        ...
        if (!m) {
            ...
            document.querySelectorAll(".modalWindow-video > iframe").forEach(function(a) {
                ...
                if (b) {
                    ...
                    else if (-1 !== b.indexOf("vimeo")) a.setAttribute("src", "https://player.vimeo.com/video/" + c[6] + "?autoplay=0&loop=0");
        ...
        "undefined" === typeof window.initTestimonialsPlugin && 0 != document.body.querySelectorAll(".testimonials-slider").length && (window.initTestimonialsPlugin = !0, document.querySelectorAll(".testimonials-slider").forEach(function(a) {
            ...
            a.addEventListener("click", function() {
                ...
                !d.classList.contains("collapsing") || -1 == b.indexOf("toggle") && -1 == b.indexOf("accordion") || (a.classList.contains("collapsed") ?
                    (f.classList.remove("mbri-arrow-up"), f.classList.add("mbri-arrow-down")) : (f.classList.remove("mbri-arrow-down"), f.classList.add("mbri-arrow-up")), -1 != b.indexOf("accordion") && (b = a.closest(".accordionStyles"), Array.from(b.children).filter(function(a) {
...
! function() {
    ...
    if (!document.getElementById("top-1")) {
        ...
        a.id = "top-1";
        a.style = "display: none";
        a.innerHTML = '<a href="https://mobirise.com?u=3069560">Mobirise</a> Mobirise v5.8.4 <a href="https://mobirise.com/website-builder/designer.html">best website builder for designers</a>';
